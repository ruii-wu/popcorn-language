...
// (Imported into the global scope, then individual screen files use these.)

const Icon = ({ d, className = "w-5 h-5", strokeWidth = 1.6 }) =>
...
function WebAvatar({ npc, size = 40, hasSomething }) {
  return (
...
function WebRelationshipDots({ value, size = 5 }) {
  return (
...
Object.assign(window, {
  WebI, NPCS_WEB, RELATIONSHIP_LABEL,
  WebAvatar, WebRelationshipDots, WebDock, WebNavRail, WebConversationsRail
});
